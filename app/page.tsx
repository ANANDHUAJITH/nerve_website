...
export default function Home() {
  ...
  // NOTE: The global IntersectionObserver that previously lived here has been
  // removed. Each component now manages its own reveal via the useReveal() hook,
  // which is SSR-safe and eliminates the hydration mismatch caused by mutating
  // classList after dynamic components mount.
  ...
  return (
    <main style={{ background: 'var(--bg)', color: 'var(--text)' }}>
      ...
      <div className="content">
        ...
        <div className="systems-strip reveal" id="systems">
